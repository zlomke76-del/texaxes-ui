...
.hero {
  ...
  background:
    ...
    radial-gradient(circle at bottom right, rgba(249, 115, 22, 0.1), transparent 24%),
...
.filterActive {
  ...
  font-size: 14px;
  font-weight: 800;
  box-shadow: 0 12px 28px rgba(124, 45, 18, 0.3);
}
...
.tableHead {
  display: none;
  gap: 16px;
  grid-template-columns: 120px 1.55fr 1fr 1fr 1fr 220px;
